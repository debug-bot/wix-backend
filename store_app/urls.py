...
urlpatterns = [
	...
	url(r'^categories/women/$',CategoryWomenListView.as_view(),name='category-list-women-view'),
	...
	url(r'^category/title/men/(?P<title>[\w\-]+)/$',CategoryTitleMenDetailView.as_view(),name='category-title-view'),
	url(r'^category/title/women/(?P<title>[\w\-]+)/$',CategoryTitleWomenDetailView.as_view(),name='category-title-view'),
	...
	url(r'^shipping-info/(?P<cart_token>[0-9A-Za-z_\-]+)/$', ShippingInfoView.as_view(), name='checkout-detail-api'),
